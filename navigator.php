...
<div class="navbar">
    <h3 class="navbar" align="center">
      ...
      <div class="dropdown"><button class="dropbtn" onClick="hoverbar()">Profiles</button><div id="profile-drop-menu" class="dropdown_content"><a href="login.php">Login</a> | <a href="usersearch.php">Search for user</a></div></div> |
