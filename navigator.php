...
<div class="navbar">
    <h3 class="navbar" align="center">
      ...
      <div class="dropdown"><button class="dropbtn" onClick="hoverbar('profile-drop-menu')">Profiles</button><div id="profile-drop-menu" class="dropdown-content"><ul><li><a href="login.php">Login</a> | </li><li><a href="usersearch.php">Search for user</a></li></ul></div></div> |
