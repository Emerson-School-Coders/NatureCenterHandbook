...
<html>
	...
	<body>
		<center>
			<?php if (!isset($_COOKIE['userid'])) echo '<p>Sorry, uploading is only available to registered accounts. Please ask Tim for an account with uploading permissions.</p><img src="NotSignedInError.ico"/><!--';
