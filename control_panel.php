...
<html>
  <head>
    <title>
      Emerson School Nature Center Handbook - Tim's Control Panel
    </title>
  ...
  <body>
    ...
    <form action="useraction.php" method="POST">
      ...
      <p>
        ...
        <br>
        Can add pages: 
        <input type="checkbox" name="canadd" value="1">
        <br>
        Can edit pages: 
        <input type="checkbox" name="canedit" value="1">
        <br>
        Can delete pages: 
        <input type="checkbox" name="candelete" value="1">
        <br>
    ...
    <form action="<?php if ($modpass) {echo "useraction.php";} else {echo htmlspecialchars($_SERVER["PHP_SELF"]);}?>" method="POST">
      ...
      <p>
        <?php 
          if (!$modpass) {
            echo 'ID: <input type="text" name="password"><br><input type="hidden" name="modpass" value="true"><input type="submit" value="Continue"><!-- ';
          }
        ?>
        ...
        Can add pages: 
        <input type="checkbox" name="canadd" value="1" <?php if ($modpass) {if ($db->querySingle("SELECT canadd FROM passwords WHERE id=" . SQLite3::escapeString($passid)) == "1") {echo "checked";}}?>><br>
        Can edit pages: 
        <input type="checkbox" name="canedit" value="1" <?php if ($modpass) {if ($db->querySingle("SELECT canedit FROM passwords WHERE id=" . SQLite3::escapeString($passid)) == "1") {echo "checked";}}?>><br>
        Can delete pages: 
        <input type="checkbox" name="candelete" value="1" <?php if ($modpass) {if ($db->querySingle("SELECT candelete FROM passwords WHERE id=" . SQLite3::escapeString($passid)) == "1") {echo "checked";}}?>><br>
