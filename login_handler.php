...
if ($final_i == FALSE) die('<p style="color: #066418; font-family: \'Trebuchet MS\'; margin: 8px; margin-left: 16px; margin-right: 12px;">You have entered an invalid password. Please go back and try again.</p>');
